#!/usr/bin/env python3
"""Roll out a tactile policy with a small 20 Hz WM/Q-head residual action."""
...
def score_q_values_20hz(
    ...
    from rollout_policy_with_20hz_q_plot import score_q_values_20hz as score_impl

    return score_impl(wm, q_head, high_tactile, high_joint, low_actions, normalizers, history, chunk, device)
...
def save_q_plot(episodes: list[dict], output: Path) -> None:
    ...
    ax.set_title("20 Hz residual policy Q-head score")
...
def parse_args():
    ...
    parser.add_argument("--out-dir", default=str(DEXMG_ROOT / "outputs/qhead_policy_rollouts/flow50k_tactile_20hz_q_residual_trust005_5rollouts_20260727"))
