...
eval_one lift_tray dexmg_lift_tray_image_tactile_vae_virtual_s8fs25 \
  ...
  "$LIFT_LOG/eval_rollout_step50000_20eps_nfe2_20260729_rerun" 2
eval_one lift_tray dexmg_lift_tray_image_tactile_vae_virtual_s8fs25 \
  "$ROOT/two_arm_lift_tray" "$ROOT/two_arm_lift_tray/shard00.hdf5" \
  "$LIFT_LOG/models/model_step50000.pt" \
  "$LIFT_LOG/eval_rollout_step50000_20eps_nfe4_20260729_rerun" 4
eval_one lift_tray dexmg_lift_tray_image_tactile_vae_virtual_s8fs25 \
  "$ROOT/two_arm_lift_tray" "$ROOT/two_arm_lift_tray/shard00.hdf5" \
  "$LIFT_LOG/models/model_step50000.pt" \
  "$LIFT_LOG/eval_rollout_step50000_20eps_nfe8_20260729_rerun" 8
...
eval_one pouring dexmg_pouring_image_tactile_vae_virtual_s8fs25 \
  ...
  "$POUR_LOG/eval_rollout_step50000_20eps_nfe2_20260729_rerun" 2
eval_one pouring dexmg_pouring_image_tactile_vae_virtual_s8fs25 \
  "$ROOT/two_arm_pouring" "$ROOT/two_arm_pouring/shard00.hdf5" \
  "$POUR_LOG/models/model_step50000.pt" \
  "$POUR_LOG/eval_rollout_step50000_20eps_nfe4_20260729_rerun" 4
eval_one pouring dexmg_pouring_image_tactile_vae_virtual_s8fs25 \
  "$ROOT/two_arm_pouring" "$ROOT/two_arm_pouring/shard00.hdf5" \
  "$POUR_LOG/models/model_step50000.pt" \
  "$POUR_LOG/eval_rollout_step50000_20eps_nfe8_20260729_rerun" 8
