#!/usr/bin/env python3
"""Wait for 01 coffee/drawer flow training and run 50-episode rollout evals."""
...
RUNS = {
    "coffee": {
        "unit": "dexmg-01-coffee-flow70k-v2-20260728.service",
        "task_config": "dexmg_coffee_image_tactile_vae_virtual_s8fs25",
        "train_log_dir": POL / "logs_dexmg_coffee_tactile_vae_flow_70k_20260728",
        "dataset_path": DATA_ROOT / "two_arm_coffee",
        "env_dataset_path": DATA_ROOT / "two_arm_coffee/shard00.hdf5",
    },
    "drawer_cleanup": {
        "unit": "dexmg-01-drawer-flow70k-v2-20260728.service",
        "task_config": "dexmg_drawer_cleanup_image_tactile_vae_virtual_s8fs25",
        "train_log_dir": POL
        / "logs_dexmg_drawer_cleanup_tactile_vae_flow_70k_20260728",
        "dataset_path": DATA_ROOT / "two_arm_drawer_cleanup",
        "env_dataset_path": DATA_ROOT / "two_arm_drawer_cleanup/shard00.hdf5",
    },
}

OUT_ROOT = DEX / "outputs/flow70k_01_coffee_drawer_eval50_20260728"
