...
ROOT="outputs/drawer_cleanup_B_newopt_sweep20_20260803"
mkdir -p "$ROOT"
...
run_one iter_terminal_k2_lr0005 iter_value terminal 0.97 2 0.0005 0.01 20 &
run_one iter_terminal_k2_lr0010 iter_value terminal 0.97 2 0.0010 0.01 20 &
wait
run_one iter_terminal_k3_lr0005 iter_value terminal 0.97 3 0.0005 0.01 20 &
run_one iter_terminal_k3_lr0010 iter_value terminal 0.97 3 0.0010 0.01 20 &
wait
run_one traj_closed_g090 closed_form trajectory 0.90 1 0.01 0.01 20 &
run_one traj_closed_g095 closed_form trajectory 0.95 1 0.01 0.01 20 &
wait
run_one traj_closed_g098 closed_form trajectory 0.98 1 0.01 0.01 20 &
run_one combo_traj_g095_k2_lr0005 iter_value trajectory 0.95 2 0.0005 0.01 20 &
wait

python - <<'PY'
import json
from pathlib import Path
root = Path("outputs/drawer_cleanup_B_newopt_sweep20_20260803")
